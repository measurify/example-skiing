...
class _startPageState extends State<startPage> {
  ...
  void fetchTags() async {
    ...
    List<String> tags2 = await getTechniqueTags();
    setState(() {
      // Update the sportsList with the fetched tags
      techniquesList = tags2;
      _selectedOption2 = techniquesList[0];
    });
  }
  ...
  void _handleValueChange(
    ...
    if (characteristicId == "8e7c2dae-0002-4b0d-b516-f525649c49ca") {
      ...
      setState(() {
        ...
        chartDataList.add(ChartData(DateTime.now(), jsonObj['values'][0]));
      });
    }
  ...
  //Get all tags
  Future<List<String>> getTechniqueTags() async {
        ...
        child: Column(
          ...
          children: [
            ...
            DropdownButton<String>(
              ...
              items: techniquesList.map<DropdownMenuItem<String>>((String value) {
                return DropdownMenuItem<String>(
                  value: value,
                  child: Text(value),
                );
...
children: <Widget>[
                SfCartesianChart(
                        ...
                        // Chart title
                        title: ChartTitle(text: 'Timeseries'),
                        // Enable legend
                        legend: Legend(isVisible: true),
                        // Enable tooltip
                        tooltipBehavior: _tooltipBehavior,
                        series : series = <CartesianSeries<dynamic, dynamic>>[
      LineSeries<ChartData, DateTime>(
        dataSource: widget.globals.chartDataList, // Usa la tua lista di dati temporali
        xValueMapper: (ChartData data, _) => data.timestamp, // Proprietà contenente il timestamp
        yValueMapper: (ChartData data, _) => data.value, // Proprietà contenente il valore
        // Enable data label
        dataLabelSettings: DataLabelSettings(isVisible: true),
             ...
             Row( //go to the chartCartesian page trasmitting globals.
                ...
                ElevatedButton(
                  ...
                  onPressed: () {
                    ...
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => chartCartesianPage(globals:widget.globals),
                      ),
                    );
                  },
                ),
